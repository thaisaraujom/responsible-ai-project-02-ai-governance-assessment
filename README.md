# Responsible AI Project 02 — AI Governance Assessment

This repository contains a comprehensive AI governance assessment of ClinicalCompanion, a fictional generative AI clinical decision support system preparing for European Union market launch.

The assessment covers:

- EU AI Act high-risk classification and compliance gaps
- NIST AI RMF risk assessment and mitigation analysis
- Third-party foundation-model vendor evaluation
- Model Card and disaggregated performance analysis
- Post-deployment monitoring and incident response
- Executive governance readiness and launch recommendation

## Key Findings

- EU AI Act classification: High-Risk AI System
- Overall governance readiness: 54.2%
- Risk register: 1 Critical, 5 High, and 2 Medium risks
- Estimated mitigation effectiveness: 47.5% risk reduction
- Vendor score: 65.2% — Conditional Approval
- Overall Top-3 diagnostic accuracy: 91.7%
- Hallucination rate: 3.4%, above the 2% target
- Final recommendation: Conditional launch subject to remediation

## Main Deliverables

- [`governance_assessment.ipynb`](governance_assessment.ipynb)
- [`governance_workbook.xlsx`](governance_workbook.xlsx)
- Six governance visualizations in [`results/`](results/)
